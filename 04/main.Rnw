...
[M8.2] $\eqspace Y_n = \sum_{j=0}^\infty \ar^{-j}\epsilon_{n+j}$.
...
\begin{equation}
 x(t) = A \sin\big( 2\pi(\omega^\prime t + \phi^\prime) \big)
 \end{equation}
