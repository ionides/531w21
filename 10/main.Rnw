...
\item A models with the Markov property may be called a \myemph{Markov chain} of a \myemph{Markov process}.
...
\myexercise. The derivation of the Kalman algebra is not central to this course. However, working through the algebra to your own satisfaction is a good exercise.
